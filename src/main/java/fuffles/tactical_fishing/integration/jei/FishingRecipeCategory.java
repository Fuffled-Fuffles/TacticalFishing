...
public class FishingRecipeCategory implements IRecipeCategory<FishingRecipe>
{
	...
	{
		this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, Items.FISHING_ROD.getDefaultInstance());
	...
	{
		return Component.translatable("jei.recipe_category.tactical_fishing.fishing");
	}
