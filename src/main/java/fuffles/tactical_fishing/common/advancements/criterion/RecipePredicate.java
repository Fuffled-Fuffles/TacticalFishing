...
public class RecipePredicate 
{
	...
	protected boolean innerMatches(Recipe<? extends Container> recipe)
	{
		...
		else if (this.result != null && !ItemStack.matches(this.result, recipe.getResultItem(null)))
		{
			return false;
		}
		else
	...
	public JsonElement serializeToJson()
	{
		...
		else
		{
			...
			if (this.result != null)
			{
				jsonObj.addProperty("result", ForgeRegistries.ITEMS.getKey(this.result.getItem()).toString());
			}
			return jsonObj;
		}
	}
